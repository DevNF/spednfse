...
class Tools extends ToolsBase
{
    ...
    /**
     * Resolve o status de uma NFSe diferente do portal da prefeitura
     */
    function resolveNfse(string $company_cnpj, int $id, array $data, array $params = []): array
    {
        try {
            $headers = [
                "company-cnpj: $company_cnpj"
            ...
            $response = $this->post("/invoice-services/$id/resolve", $data, $params, $headers);
